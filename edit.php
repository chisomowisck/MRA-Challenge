...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="taxpayer.html" target="_blank">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="pages/tables.html">
            ...
            <span class="nav-link-text ms-1">TaxPayer</span>
          </a>
        </li>
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Taxpayers</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Tax Payers</h6>
        </nav>
                        ...
                        <form role="form">
                            <div class="row">
                                <div class="col-md-6"><label>TPIN</label>
                                    <div class="mb-3">
                                      <input type="text" class="form-control" placeholder="TPIN">
                                    </div>
                                </div>
                                <div class="col-md-6"><label>Business Certificate Number</label>
                                    <div class="mb-3">
                                      <input type="text" class="form-control" placeholder="Business Certificate Number">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6"><label>Business Registration Date</label>
                                    <div class="mb-3">
                                      <input type="text" class="form-control" placeholder="Business Registration Date">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="mb-3">
                              <input type="text" class="form-control" placeholder="Physical Location">
                            </div>
                            <div class="text-center">
                              <a href="taxpayer.html" type="button" class="btn bg-gradient-info w-100 mt-4 mb-4">Update</a>
                            </div>
                          </form>
                      </div>
                    </div>
